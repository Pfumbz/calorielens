  ...
  MealPlan(
    ...
    meals: [
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'maize meal', quantity: '500g', estimatedPrice: 12, category: 'grain'),
          Ingredient(name: 'eggs', quantity: '6 pack', estimatedPrice: 18, category: 'protein'),
        ],
      ),
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'chakalaka (tin)', quantity: '410g', estimatedPrice: 18, category: 'pantry'),
          Ingredient(name: 'brown bread', quantity: '1 loaf', estimatedPrice: 16, category: 'grain'),
        ],
      ),
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'boerewors', quantity: '500g', estimatedPrice: 55, category: 'protein'),
        ],
      ),
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'rusks', quantity: '500g pack', estimatedPrice: 35, category: 'pantry'),
          Ingredient(name: 'rooibos tea', quantity: '40 bags', estimatedPrice: 22, category: 'pantry'),
        ],
      ),
    ],
  ),
  ...
  MealPlan(
    ...
    meals: [
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'eggs', quantity: '6 pack', estimatedPrice: 18, category: 'protein'),
          Ingredient(name: 'biltong (sliced)', quantity: '100g', estimatedPrice: 45, category: 'protein'),
          Ingredient(name: 'butter', quantity: '250g', estimatedPrice: 28, category: 'dairy'),
          Ingredient(name: 'white bread', quantity: '1 loaf', estimatedPrice: 16, category: 'grain'),
        ],
      ),
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'chicken breasts', quantity: '500g', estimatedPrice: 55, category: 'protein'),
          Ingredient(name: 'white rice', quantity: '1kg', estimatedPrice: 18, category: 'grain'),
          Ingredient(name: 'Aromat', quantity: '75g', estimatedPrice: 15, category: 'spice'),
        ],
      ),
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'rump steak', quantity: '300g', estimatedPrice: 65, category: 'protein'),
          Ingredient(name: 'sweet potato', quantity: '2 medium', estimatedPrice: 15, category: 'produce'),
        ],
      ),
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'droëwors', quantity: '100g', estimatedPrice: 40, category: 'protein'),
          Ingredient(name: 'mixed nuts', quantity: '200g', estimatedPrice: 35, category: 'pantry'),
        ],
      ),
    ],
  ),
  ...
  MealPlan(
    ...
    meals: [
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'brown bread', quantity: '1 loaf', estimatedPrice: 16, category: 'grain'),
          Ingredient(name: 'peanut butter', quantity: '400g', estimatedPrice: 28, category: 'pantry'),
          Ingredient(name: 'bananas', quantity: '1kg (6-7)', estimatedPrice: 15, category: 'produce'),
        ],
      ),
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'sugar beans (tin)', quantity: '410g', estimatedPrice: 14, category: 'pantry'),
          Ingredient(name: 'onions', quantity: '1kg bag', estimatedPrice: 12, category: 'produce'),
          Ingredient(name: 'tomatoes', quantity: '4 medium', estimatedPrice: 10, category: 'produce'),
          Ingredient(name: 'curry powder', quantity: '100g', estimatedPrice: 15, category: 'spice'),
          Ingredient(name: 'white bread (unsliced)', quantity: '1 loaf', estimatedPrice: 18, category: 'grain'),
        ],
      ),
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'gem squash', quantity: '4 pieces', estimatedPrice: 20, category: 'produce'),
          Ingredient(name: 'cheddar cheese', quantity: '200g', estimatedPrice: 30, category: 'dairy'),
        ],
      ),
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'mango atchar', quantity: '380g', estimatedPrice: 25, category: 'pantry'),
          Ingredient(name: 'poppadums', quantity: '100g pack', estimatedPrice: 18, category: 'pantry'),
        ],
      ),
    ],
  ),
  ...
  MealPlan(
    ...
    meals: [
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'rolled oats', quantity: '1kg', estimatedPrice: 25, category: 'grain'),
          Ingredient(name: 'long-life milk', quantity: '1L', estimatedPrice: 18, category: 'dairy'),
          Ingredient(name: 'chia seeds', quantity: '200g', estimatedPrice: 30, category: 'pantry'),
          Ingredient(name: 'bananas', quantity: '1kg', estimatedPrice: 15, category: 'produce'),
        ],
      ),
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'chicken thighs', quantity: '1kg', estimatedPrice: 55, category: 'protein'),
          Ingredient(name: 'white rice', quantity: '2.5kg', estimatedPrice: 35, category: 'grain'),
          Ingredient(name: 'broccoli', quantity: '2 heads', estimatedPrice: 25, category: 'produce'),
          Ingredient(name: 'garlic', quantity: '3 bulbs', estimatedPrice: 10, category: 'produce'),
        ],
      ),
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'beef mince', quantity: '1kg', estimatedPrice: 70, category: 'protein'),
          Ingredient(name: 'samp & beans', quantity: '1kg', estimatedPrice: 22, category: 'grain'),
          Ingredient(name: 'tinned tomatoes', quantity: '400g x2', estimatedPrice: 20, category: 'pantry'),
          Ingredient(name: 'Rajah curry powder', quantity: '100g', estimatedPrice: 18, category: 'spice'),
        ],
      ),
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'eggs', quantity: '18 pack', estimatedPrice: 45, category: 'protein'),
        ],
      ),
    ],
  ),
  ...
  MealPlan(
    ...
    meals: [
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'bread rolls', quantity: '6 pack', estimatedPrice: 20, category: 'grain'),
          Ingredient(name: 'apricot jam', quantity: '450g', estimatedPrice: 22, category: 'pantry'),
        ],
      ),
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'beef mince', quantity: '500g', estimatedPrice: 50, category: 'protein'),
          Ingredient(name: "Mrs Ball's chutney", quantity: '470g', estimatedPrice: 28, category: 'pantry'),
          Ingredient(name: 'turmeric', quantity: '50g', estimatedPrice: 12, category: 'spice'),
          Ingredient(name: 'raisins', quantity: '250g', estimatedPrice: 20, category: 'pantry'),
          Ingredient(name: 'basmati rice', quantity: '1kg', estimatedPrice: 28, category: 'grain'),
        ],
      ),
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'stewing lamb/beef', quantity: '500g', estimatedPrice: 60, category: 'protein'),
          Ingredient(name: 'potatoes', quantity: '1kg bag', estimatedPrice: 18, category: 'produce'),
          Ingredient(name: 'spinach', quantity: '250g', estimatedPrice: 15, category: 'produce'),
        ],
      ),
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'koeksisters (pack)', quantity: '6 pack', estimatedPrice: 30, category: 'pantry'),
        ],
      ),
    ],
  ),
  ...
  MealPlan(
    ...
    meals: [
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'instant oats', quantity: '1kg', estimatedPrice: 22, category: 'grain'),
          Ingredient(name: 'peanut butter', quantity: '400g', estimatedPrice: 28, category: 'pantry'),
        ],
      ),
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'pilchards in tomato', quantity: '400g tin', estimatedPrice: 18, category: 'protein'),
          Ingredient(name: 'white rice', quantity: '1kg', estimatedPrice: 18, category: 'grain'),
          Ingredient(name: 'onions', quantity: '1kg', estimatedPrice: 12, category: 'produce'),
          Ingredient(name: 'tomatoes', quantity: '3 medium', estimatedPrice: 8, category: 'produce'),
        ],
      ),
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'cake flour', quantity: '2.5kg', estimatedPrice: 28, category: 'grain'),
          Ingredient(name: 'instant yeast', quantity: '10g sachet', estimatedPrice: 5, category: 'pantry'),
          Ingredient(name: 'beef mince', quantity: '500g', estimatedPrice: 50, category: 'protein'),
          Ingredient(name: 'cooking oil', quantity: '750ml', estimatedPrice: 25, category: 'pantry'),
        ],
      ),
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'Marie biscuits', quantity: '200g pack', estimatedPrice: 12, category: 'pantry'),
        ],
      ),
    ],
  ),
  ...
  MealPlan(
    ...
    meals: [
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'boerewors', quantity: '500g', estimatedPrice: 55, category: 'protein'),
          Ingredient(name: 'hot dog rolls', quantity: '6 pack', estimatedPrice: 18, category: 'grain'),
          Ingredient(name: 'onions', quantity: '1kg', estimatedPrice: 12, category: 'produce'),
        ],
      ),
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'chicken pieces', quantity: '1kg', estimatedPrice: 60, category: 'protein'),
          Ingredient(name: 'peri-peri sauce', quantity: '250ml', estimatedPrice: 25, category: 'pantry'),
          Ingredient(name: 'mielies (corn)', quantity: '4 cobs', estimatedPrice: 20, category: 'produce'),
        ],
      ),
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'T-bone steak', quantity: '400g', estimatedPrice: 90, category: 'protein'),
          Ingredient(name: 'white bread', quantity: '1 loaf', estimatedPrice: 16, category: 'grain'),
          Ingredient(name: 'cheddar cheese', quantity: '200g', estimatedPrice: 30, category: 'dairy'),
          Ingredient(name: 'tomatoes', quantity: '3 medium', estimatedPrice: 8, category: 'produce'),
        ],
      ...
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'melktert', quantity: '1 whole', estimatedPrice: 45, category: 'pantry'),
        ],
      ),
    ],
  ),
  ...
  MealPlan(
    ...
    meals: [
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'sourdough bread', quantity: '1 loaf', estimatedPrice: 30, category: 'grain'),
          Ingredient(name: 'avocados', quantity: '3 pack', estimatedPrice: 25, category: 'produce'),
          Ingredient(name: 'eggs', quantity: '6 pack', estimatedPrice: 18, category: 'protein'),
        ],
      ),
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'tinned tuna', quantity: '170g x2', estimatedPrice: 30, category: 'protein'),
          Ingredient(name: 'tortilla wraps', quantity: '6 pack', estimatedPrice: 25, category: 'grain'),
          Ingredient(name: 'mayo', quantity: '375ml', estimatedPrice: 22, category: 'pantry'),
          Ingredient(name: 'sweetcorn (tin)', quantity: '410g', estimatedPrice: 14, category: 'pantry'),
        ],
      ),
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'chicken breast', quantity: '500g', estimatedPrice: 55, category: 'protein'),
          Ingredient(name: '2-minute noodles', quantity: '5 pack', estimatedPrice: 18, category: 'grain'),
          Ingredient(name: 'frozen stir-fry veg', quantity: '500g', estimatedPrice: 25, category: 'produce'),
        ],
      ),
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'biltong (sliced)', quantity: '100g', estimatedPrice: 45, category: 'protein'),
          Ingredient(name: 'apples', quantity: '1kg bag', estimatedPrice: 25, category: 'produce'),
        ],
      ),
    ],
  ),
  ...
  MealPlan(
    ...
    meals: [
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'maize meal', quantity: '1kg', estimatedPrice: 15, category: 'grain'),
          Ingredient(name: 'bananas', quantity: '1kg', estimatedPrice: 15, category: 'produce'),
          Ingredient(name: 'golden syrup', quantity: '500ml', estimatedPrice: 22, category: 'pantry'),
        ],
      ),
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'red lentils', quantity: '500g', estimatedPrice: 22, category: 'pantry'),
          Ingredient(name: 'basmati rice', quantity: '1kg', estimatedPrice: 28, category: 'grain'),
          Ingredient(name: 'onions', quantity: '1kg', estimatedPrice: 12, category: 'produce'),
          Ingredient(name: 'curry powder', quantity: '100g', estimatedPrice: 15, category: 'spice'),
        ],
      ...
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'butternut', quantity: '1 large', estimatedPrice: 20, category: 'produce'),
          Ingredient(name: 'vegetable stock cubes', quantity: '10 pack', estimatedPrice: 10, category: 'pantry'),
          Ingredient(name: 'brown bread', quantity: '1 loaf', estimatedPrice: 16, category: 'grain'),
        ],
      ),
      PlanMeal(
        ...
        ingredients: [
          Ingredient(name: 'chickpeas (tin)', quantity: '400g x2', estimatedPrice: 24, category: 'pantry'),
          Ingredient(name: 'olive oil', quantity: '250ml', estimatedPrice: 35, category: 'pantry'),
          Ingredient(name: 'paprika', quantity: '50g', estimatedPrice: 10, category: 'spice'),
        ],
      ),
    ],
  ),
